...
PRED_FILE = "/home/hpc/ihpc/ihpc134h/master/ionchan_pro/outputs/freeze_softdwell/new/predictions_nn1.npy"
TARG_FILE = "/home/hpc/ihpc/ihpc134h/master/ionchan_pro/outputs/freeze_softdwell/new/targets_nn1.npy"
...
for i in range(preds_hz.shape[1]):
    ...
    plt.tight_layout()
    plt.savefig(f"/home/hpc/ihpc/ihpc134h/master/ionchan_pro/outputs/freeze_softdwell/graphs/scatter_output111_{i}.png", dpi=150)
    plt.close()
